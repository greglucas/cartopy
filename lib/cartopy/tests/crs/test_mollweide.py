...
def test_default():
    ...
    assert_almost_equal(np.array(moll.x_limits), [-18040095.6961473, 18040095.6961473])
    assert_almost_equal(np.array(moll.y_limits), [-9020047.8480736, 9020047.8480736])
...
def test_central_longitude(lon):
    ...
    assert_almost_equal(
        np.array(moll.x_limits), [-18040095.6961473, 18040095.6961473], decimal=5
    )
    assert_almost_equal(np.array(moll.y_limits), [-9020047.8480736, 9020047.8480736])
...
def test_grid():
    ...
    assert_almost_equal(np.array(moll.x_limits), [-2, 2])
    assert_almost_equal(np.array(moll.y_limits), [-1, 1])
...
def test_sphere_transform():
    ...
    assert_almost_equal(
        np.array(moll.x_limits), [-2.8284271247461903, 2.8284271247461903], decimal=2
    )
    assert_almost_equal(
        np.array(moll.y_limits), [-1.4142135623730951, 1.4142135623730951]
    )
